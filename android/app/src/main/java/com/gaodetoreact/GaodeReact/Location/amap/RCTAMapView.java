package com.gaodetoreact.GaodeReact.Location.amap;
...
import com.gaodetoreact.GaodeReact.Location.amap.util.SensorEventHelper;
...
//        mSensorHelper.setCurrentMarker(mLocMarker);//定位图标旋转
    ...
    private int getImageId(String fileName) {
        int drawableId = CONTEXT.getCurrentActivity().getResources().getIdentifier(fileName, "drawable", CONTEXT.getClass().getPackage().getName());
        if (drawableId == 0) {
